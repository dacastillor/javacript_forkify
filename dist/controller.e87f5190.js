...
exports.TIMEOUT_SEC = exports.REST_PER_PAGES = exports.MODAL_CLOSE_SEC = exports.KEY = exports.API_URL = void 0;
...
var KEY = 'b1d3cb6f-23ed-446e-92f5-9e0a764e8b25';
exports.KEY = KEY;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          recipeAPI = _context.sent;
          _context.next = 8;
          return recipeAPI.json();
        case 8:
          ...
          throw new Error("Error: ".concat(recipeData.message, " ").concat(recipeAPI.status));
        case 11:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _helpers.AJAX)( // información desde API
          "".concat(_config.API_URL).concat(id, "?key=").concat(_config.KEY));
        case 3:
          reciData = _context.sent;
        ...
        case 8:
          ...
          // Error temporal
          console.error("".concat(_context.t0, " (Temporal Version)"));
          throw _context.t0;
        case 12:
        case "end":
          return _context.stop();
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          state.search.results = searchData.data.recipes.map(function (rec) {
            return _objectSpread({
              id: rec.id,
              title: rec.title,
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
     ...
     * @param {Object | Array of Objects} data The to be rendered (e.g. recipe)
    ...
    function render(data) {
      ...
      this._data = data;
      var markupHTML = this._generateMarkup();
      if (!_render) return markupHTML;
      this._clear();
    ...
    value: function update(data) {
      ...
      newElements.forEach(function (newEl, i) {
        ...
        if (!newEl.isEqualNode(curEl) && ((_newEl$firstChild = newEl.firstChild) === null || _newEl$firstChild === void 0 ? void 0 : _newEl$firstChild.nodeValue.trim()) !== '') {
          // Este va a actualizar sólo los campos de texto que perciban cambios dentro de sus elementos hijos
        ...
        }); // Cambiar los atributos de los elementos para poder usar los botones y actualizar el DOM            
      });
    }
  }, {
    key: "renderSpinner",
    ...
    value: function renderSuccess() {
      var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._succMsg;
      var markupError = "\n      <div class=\"message\">\n        <div>\n          <svg>\n            <use href=\"".concat(_icons.default, ".svg#icon-smile\"></use>\n          </svg>\n        </div>\n        <p>").concat(message, "</p>\n      </div>\n    ");
      this._clear();
      this._parentElement.insertAdjacentHTML('afterbegin', markupError);
    }
  }]);
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
// se usa este porque fractional no funcionó
...
var RecipeView = /*#__PURE__*/function (_View) {
  ...
  function RecipeView() {
    ...
    // se hace de uso protegido para no permitir alterar fácilmente la vista, se hace protegido y no privado por Babel  
    _defineProperty(_assertThisInitialized(_this), "_errorMsg", 'Sorry, there was a problem getting this recipe. Try again');
    _defineProperty(_assertThisInitialized(_this), "_succMsg", '');
    return _this;
  }
  _createClass(RecipeView, [{
    ...
    key: "addHadlerUpdateServing",
    value: function addHadlerUpdateServing(handler) {
...
},{"./View":"src/js/views/View.js","../../img/icons.svg":"src/img/icons.svg","fracty":"node_modules/fracty/fracty.js"}],"node_modules/core-js/internals/global.js":[function(require,module,exports) {
...
var ResultsView = /*#__PURE__*/function (_View) {
  ...
  function ResultsView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_errorMsg", 'Sorry, not recipe found for your query. Try again');
    _defineProperty(_assertThisInitialized(_this), "_succMsg", '');
    return _this;
  }
...
var PaginationView = /*#__PURE__*/function (_View) {
  ...
  _createClass(PaginationView, [{
    key: "addClickHandler",
    value: function addClickHandler(handler) {
      this._parentElement.addEventListener('click', function (e) {
        ...
        var goToPageData = +btn.dataset.goto;
...
var BookmarksView = /*#__PURE__*/function (_View) {
  ...
  function BookmarksView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_errorMsg", 'No bookmarks added yet');
    _defineProperty(_assertThisInitialized(_this), "_succMsg", '');
    return _this;
  }
...
exports.default = _default;
},{"./View":"src/js/views/View.js","./previewView.js":"src/js/views/previewView.js"}],"src/js/views/addRecipeView.js":[function(require,module,exports) {
"use strict";
...
var AddRecipeView = /*#__PURE__*/function (_View) {
  ...
  function AddRecipeView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_succMsg", 'Recipe uploaded succesfully');
  ...
  _createClass(AddRecipeView, [{
    ...
    value: function addHandlerUpload(handler) {
      this._parentElement.addEventListener('submit', function (e) {
        e.preventDefault();
        var dataArray = _toConsumableArray(new FormData(this)); // Esto es una API que toma la información de un form y los vuelve pares dentro de un Array. eg [title,"TEST"],...
        var data = Object.fromEntries(dataArray); // esto toma los entries del array anterior y los transforma a notación de objeto, eg {title: "TEST",...}
        handler(data);
      });
    }
  }, {
...
exports.default = _default;
},{"./View":"src/js/views/View.js","../../img/icons.svg":"src/img/icons.svg"}],"src/js/controller.js":[function(require,module,exports) {
var define;
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          id = window.location.hash.slice(1); // agarra el hash de cada receta dependiendo de lo que este en la variabel global ventana
          if (id) {
            _context.next = 4;
            break;
          }
        ...
        case 4:
          ...
          _resultsView.default.update(model.getSearchResultsPage()); // con esto se queda seleccionada 
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(newRecipe) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          _recipeView.default.render(model.state.recipe);
          _addRecipeView.default.renderSuccess();
          _bookmarksView.default.render(model.state.bookmarks);
...
//clearBookmarks();
},{"./model.js":"src/js/model.js","./views/recipeView.js":"src/js/views/recipeView.js","./config.js":"src/js/config.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./views/searchView.js":"src/js/views/searchView.js","./views/resultsView.js":"src/js/views/resultsView.js","./views/paginationView.js":"src/js/views/paginationView.js","./views/bookmarksView.js":"src/js/views/bookmarksView.js","./views/addRecipeView.js":"src/js/views/addRecipeView.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
